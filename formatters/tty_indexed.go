...
type ttyTable struct {
	foreground map[zdpgo_pygments.Colour]string
	background map[zdpgo_pygments.Colour]string
}

var c = zdpgo_pygments.MustParseColour
...
func entryToEscapeSequence(table *ttyTable, entry zdpgo_pygments.StyleEntry) string {
	out := ""
...
func findClosest(table *ttyTable, seeking zdpgo_pygments.Colour) zdpgo_pygments.Colour {
	closestColour := zdpgo_pygments.Colour(0)
...
func styleToEscapeSequence(table *ttyTable, style *zdpgo_pygments.Style) map[zdpgo_pygments.TokenType]string {
	style = clearBackground(style)
	out := map[zdpgo_pygments.TokenType]string{}
...
func clearBackground(style *zdpgo_pygments.Style) *zdpgo_pygments.Style {
	builder := style.Builder()
	bg := builder.Get(zdpgo_pygments.Background)
	bg.Background = 0
	bg.NoInherit = true
	builder.AddEntry(zdpgo_pygments.Background, bg)
...
func (c *indexedTTYFormatter) Format(w io.Writer, style *zdpgo_pygments.Style, it zdpgo_pygments.Iterator) (err error) {
